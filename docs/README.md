...
[ACA-PLAN-002: evidence repair and cross-repository reuse](plans/2026-09-21-evidence-repair-cross-repo-reuse.md) completed its read-only tranche on 2026-09-22. A0 evidence repair merged in PR #63, A1 brownfield portability in PR #64, and the A2 instrument/freeze corrections in PRs #66–67. The scored A3 pair is recorded in [A3_A4_RESULT.md](experiments/cross-repo-reuse/A3_A4_RESULT.md): control delivered 33/35 hidden checks in 295 seconds; treatment delivered 35/35 in 374 seconds but explicitly **rejected** the retained Product N asset for dependency and semantic-fit reasons. This is a bounded negative result for economic reuse and a bounded positive result for explicit fit/rejection discipline. A5 effect-safety is deferred because no new effectful-readiness claim is made. The governing [ACA research agenda](RESEARCH_AGENDA.md) remains prior-art first: use established reuse methods, standards, catalogs, contract-testing patterns, and runtimes rather than recreating them.
