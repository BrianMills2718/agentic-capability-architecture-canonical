...
MODULE = ROOT / "clients/shipment_exception/custom/frappe_app/shipment_exception/shipment_exception/workflow.py"
spec = importlib.util.spec_from_file_location("shipment_exception_workflow_test", MODULE)
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)

apply_shipment_exception = module.apply_shipment_exception
evaluate_shipment_exception = module.evaluate_shipment_exception
notify_exception_team = module.notify_exception_team
