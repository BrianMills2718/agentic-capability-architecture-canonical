...
def test_provider_bound_slice_executes_and_emits_traceable_receipts(monkeypatch):
    ...
    receipts.append({
        ...
        "provenance": provenance["req:appointment-policy-resolution"],
    })
    ...
    receipts.append({
        ...
        "provenance": provenance["req:appointment-approval-transition"],
    })
    ...
    receipts.append({
        ...
        "status": "succeeded",
        "outputs": {"delivery_ref": delivery},
        "provenance": provenance["req:appointment-reminder-notification"],
    })

    assert [r["semantic_action"] for r in receipts] == [
        "policy.resolve",
        "state.transition",
        "notification.send",
    ]
